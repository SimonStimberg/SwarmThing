...
void draw() {
  ...
  //if(skipCaptureFrame == 0) {
  //  saveFrame("render/swarm-######.tif");
  //  skipCaptureFrame = 1;
  //} else {
  //  skipCaptureFrame--;
  //}
  ...
  println("Framerate: " + int(frameRate) + " | Boids: " + int(flock.boids.size()) + " | Captured Seconds: " + int(frameCounter/50));
}

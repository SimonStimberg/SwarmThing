...
void checkDepth() {
  ...
  if(depth >= newDepth+0.1 || depth <= newDepth-0.1) {
...
void newWall() {
  ...
  wall.addPoint(width*0.377-offset*2,0+depth+100);
  wall.addPoint(width*0.377,0+depth+100+offset*2);
  wall.addPoint(width-width*0.377,0+depth+100+offset*2);
  wall.addPoint(width-width*0.377+offset*2,0+depth+100);
